...
#Most recently edited 4/13/2015
...
li $t1, 1
li $t2, 10
addi $s1, -0x30 		#subtract 0x30 to convert from ascii to actual value
add $t0, $zero, $s6
...
letter:
sb $s1, 0($s3)			#save character of the authors name to memory
...
add.s $f10, $f10, $f8		#f10 = 1/2, first guess
jal calculate_root			#returns f10 = square root of f28
